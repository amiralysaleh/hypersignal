...
async function saveSettingsRequest(settings: Settings): Promise<void> {
...
export default function SettingsPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    startTransition(async () => {
      try {
        await saveSettingsRequest(settings as Settings);
        toast({
          title: 'Success',
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-muted-foreground">Configure the signal detection and alert parameters.</p>
      </div>
          ...
          <Card>
            <TabsContent value="general" className="mt-0">
              <CardHeader>
                ...
                <CardDescription>
                  Configure core detection and polling parameters. Select a profile or customize below.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Input
                      id="walletPollInterval"
                      type="number"
                      value={settings.walletPollInterval ?? ''}
                      onChange={handleInputChange}
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      id="pricePollInterval"
                      type="number"
                      value={settings.pricePollInterval ?? ''}
                      onChange={handleInputChange}
                    />
                  </div>
                </div>
              ...
              <CardContent className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      id="takeProfitTargets"
                      placeholder="e.g., 2.0, 3.5, 5.0"
                ...
                <div className="flex items-center space-x-2 pt-4">
                  <Switch
                    id="includeFunding"
                    checked={settings.includeFunding ?? false}
                    onCheckedChange={(checked) => handleSwitchChange(checked, 'includeFunding')}
                  />
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    value={settings.telegramChannelIds ?? ''}
                    onChange={handleInputChange}
                  />
                </div>
              </CardContent>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    value={settings.quoteCurrencies ?? ''}
                    onChange={handleInputChange}
                  />
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    id="ignoredPairs"
                    placeholder="e.g., MEME, PEPE"
                    value={settings.ignoredPairs ?? ''}
                    onChange={handleInputChange}
                  />
